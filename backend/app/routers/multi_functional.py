...
from ..models import MultiFunctionalProject, MultiFunctionalAnswer, MultiFunctionalSubmission, MultiFunctionalSettings, User
from ..schemas import (
...
def get_random_project(
    ...
    """Get a random multi-functional project."""
